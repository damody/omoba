...
$manifest=[ordered]@{schema_version=1;mode=$Mode;created_utc=[DateTime]::UtcNow.ToString('o');rustc=(& rustc --version);ports=@{server='127.0.0.1:50061';team_1_presentation='127.0.0.1:62001';team_2_presentation='127.0.0.1:62002'};processes=@(
