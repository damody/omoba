...
impl Fixed64 {
    ...
    pub const fn from_raw(raw: i64) -> Self { Fixed64(raw) }
    pub const fn from_i32(v: i32) -> Self { Fixed64((v as i64).wrapping_mul(SCALE)) }
    ...
    pub fn sqrt(self) -> Fixed64 {
        if self.0 <= 0 { return Fixed64::ZERO; }
...
impl std::ops::Add for Fixed64 {
    type Output = Fixed64;
    fn add(self, rhs: Fixed64) -> Fixed64 { Fixed64(self.0.wrapping_add(rhs.0)) }
}

impl std::ops::Sub for Fixed64 {
    type Output = Fixed64;
    fn sub(self, rhs: Fixed64) -> Fixed64 { Fixed64(self.0.wrapping_sub(rhs.0)) }
}
...
impl std::ops::Mul<i32> for Fixed64 {
    ...
    fn mul(self, rhs: i32) -> Fixed64 { Fixed64(self.0.wrapping_mul(rhs as i64)) }
}

impl std::ops::Mul<Fixed64> for i32 {
    type Output = Fixed64;
    fn mul(self, rhs: Fixed64) -> Fixed64 { Fixed64((self as i64).wrapping_mul(rhs.0)) }
}
...
impl std::ops::Neg for Fixed64 {
    type Output = Fixed64;
    fn neg(self) -> Fixed64 { Fixed64(self.0.wrapping_neg()) }
}

impl std::ops::AddAssign for Fixed64 {
    fn add_assign(&mut self, rhs: Fixed64) { self.0 = self.0.wrapping_add(rhs.0); }
}

impl std::ops::SubAssign for Fixed64 {
    fn sub_assign(&mut self, rhs: Fixed64) { self.0 = self.0.wrapping_sub(rhs.0); }
}

impl std::ops::MulAssign for Fixed64 {
    fn mul_assign(&mut self, rhs: Fixed64) { *self = *self * rhs; }
}

impl std::ops::DivAssign for Fixed64 {
    fn div_assign(&mut self, rhs: Fixed64) { *self = *self / rhs; }
}
...
mod tests {
    ...
    fn mul_large_position_squared() {
        ...
        assert!(sq.raw() > 0, "squared value went negative — overflow regression");
    }
    ...
    #[test]
    fn mul_negative() {
        assert_eq!(Fixed64::from_i32(-3) * Fixed64::from_i32(4), Fixed64::from_i32(-12));
        assert_eq!(Fixed64::from_i32(-3) * Fixed64::from_i32(-4), Fixed64::from_i32(12));
    }
    ...
    fn sqrt_large_value() {
        ...
        assert!(diff <= 2, "sqrt(7,840,000) raw={} expected~={}, diff={}",
            r.raw(), Fixed64::from_i32(2800).raw(), diff);
    }
