...
定義 omfx 到 omb lockstep input 的 render latency metric contract，讓 input submit、server echo、snapshot pairing、rolling latency calculation、HUD 顯示與 determinism 邊界保持一致。
## Requirements
