...
Define how hero 3D render metadata is declared by scripts content, exposed through generated runtime data and snapshots, and consumed by omfx as a render-only visual feature with safe fallback behavior.
