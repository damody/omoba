...
- [x] 1.3 在 `scripts/lua_data/templates/heroes.lua` 為 `saika_magoichi` 加入 `render = { render_mode = "model_3d", model = "templates/heroes/saika_magoichi/saika_magoichi.fbx", texture = "templates/heroes/saika_magoichi/saika_magoichi_mat.png", scale = ..., pitch_offset_deg = ..., roll_offset_deg = ..., yaw_offset_deg = ..., z_offset = ..., muzzle_bone = ..., animation_sources = { move = { model = "templates/heroes/saika_magoichi/b01_ani_run.fbx", animation = "Take 001", duration_ticks = 23.0, ticks_per_second = 30.0, timeline_offset_ticks = ... }, attack = { model = "templates/heroes/saika_magoichi/b01_ani_attack.fbx", animation = "Take 001", duration_ticks = 100.0, ticks_per_second = 30.0, timeline_offset_ticks = ... }, critical = ..., sniper = ... }, animations = { move = { source = "move", start_tick = 0.0, end_tick = 23.0, loop = true }, attack = { source = "attack", start_tick = 0.0, impact_tick = 22.0, end_tick = 100.0 }, critical = ..., sniper = ... } }`，並確認路徑相對於 `scripts/lua_data/` 可解析
